  ...
  <Layout>
    ...
    <div className="pp-container">
      ...
      <p>
        ...
        policy that you do not agree with, please discontinue use of our Apps
        and our services.
      </p>
      <br />
      <br />
      ...
      <i>
        ...
        such as name, contact information, passwords, and social media login
        data.
      </i>
      <br />
      <br />
      <p>
        ...
        registering at the Apps, expressing an interest in obtaining our
      ...
      <p>
        ...
        interactions with us and the Apps, the choices you make and the products
        and features you use. The personal information we collect can include
        the following:
      </p>
      <br />
      <br />
      <ul>
        <li>
          ...
          last name; email addresses; and other similar data.
          <br />
          <br />
        </li>
        <li>
          <b>Personal Information Provided by You.</b> We collect universities
          career data and other similar data.
          <br />
          <br />
        </li>
        <li>
          ...
          of information are securely encrypted.
          <br />
          <br />
        </li>
        <li>
      ...
      notification, biometric identification, and other features. If you wish to
      ...
      <br />
      <i>
        <b>In Short:</b> We may collect limited data from public databases of
        universities, advert, social media platforms, and other outside sources.
      </i>
      <br />
      <br />
      <p>
        {" "}
        We may obtain information about your from other sources, such as public
        databases, joint marketing partners, social media platforms (such as
        Facebook and Google), as well as from other third parties. Examples of
        the information we receive from other sources include: email; marketing
      ...
      <br />
      <p>
        All the information collected through our Apps are the one that you can
        see into the Apps screens, all passwords and pins will not be collected
        into our database to guarantee your safety.
      </p>
      <br />
      <br />
      ...
      <ul>
        <li>
          <b>To facilitate account creation and login process.</b> If you choose
          ...
          login process for the performance of the contract. See the section
        ...
        <li>
          <b>To post testimonials.</b> We post testimonials on our Apps that may
          ...
          <a href="mailto:uniu.app@gmail.com">uniu.app@gmail.com</a> and be sure
      ...
      companies to serve ads when you visit the Apps. These companies may use
      ...
      <p>
        {" "}
        Our Apps offer you the ability to register and login using your third
        party social media account details (like your Facebook or Google
        logins). Where you choose to do this, we will receive certain profile
        information about you from your social media provider. The profile
        Information we receive may vary depending on the social media provider
        concerned, but will often include your e-mail address as well as other
      ...
      <p>
        ...
        email us at <a href="mailto:uniu.app@gmail.com">uniu.app@gmail.com</a>.
      </p>
      <br />
      <br />
      ...
      <br />
      <p>
        A privacy breach occurs when there is unauthorized access to our
        collection. You will be notified about data breaches when UniU believes
      ...
      <br />
      <i>
        <b>In Short:</b> Yes, we will update this policy as necessary to stay
      ...
      <p>
        ...
        <a href="mailto:uniu.app@gmail.com">uniu.app@gmail.com</a> or visiting{" "}
        <a href="http://www.uniu.it">www.uniu.it.</a>
      </p>
      <br />
    </div>
  </Layout>
